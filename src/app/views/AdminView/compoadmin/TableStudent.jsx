//Tabla de estudiantes para validar su formulario
import {
    Box,
    styled,
    Table,
  ...
  //Estilo de perteneciente al boton validar
  const ButtonSmall = styled(Button)(({ bgcolor }) => ({
    width: 30,
    height: 20,
    color: '#fff',
    padding: '2px 8px',
            ...
            {AlumnosData
              ...
              .map((alumndata, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell align="center">{alumndata.enterprise}</TableCell>
                  ...
                  <TableCell align="center">
                    <ButtonSmall align='center' bgcolor={bgPrimary}>Validar</ButtonSmall>
                  </TableCell>
                </TableRow>
              ))}
          </TableBody>
