...
import CVerticalNavExpansionPanel from './CVerticalNavExpansionPanel'; 
...
const CVerticalNav = ({ items }) => {
  ...
  const renderLevels = (data) => {
    return data.map((item, index) => {
      ...
      if (item.children) {
        return (
          <CVerticalNavExpansionPanel mode={mode} item={item} key={index}>
            {renderLevels(item.children)}
          </CVerticalNavExpansionPanel>
        );
...
export default React.memo(CVerticalNav);